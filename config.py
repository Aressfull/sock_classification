...
parser.add_argument('--data_path', default='data_classification/sock_classification')
...
parser.add_argument('-use_L1','--use_L1', type=bool, default=False)
parser.add_argument('-lambda_L1','--lambda_L1', type=float, default=1e-4)
...
parser.add_argument('-n_pretrain','--n_pretrain', type=int, default=parser.parse_known_args()[0].n_epoch)
